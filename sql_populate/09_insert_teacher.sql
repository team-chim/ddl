...
VALUES ('0123456789', 'Prabhas', NULL,'Chongstitvatana', 'ประภาส', NULL, 'จงสถิตย์วัฒนา', 'Prabhas.C@chula.ac.th','0000000000',21,10,'2001-05-01'),
       ('1234567890', 'Atiwong', NULL,'Suchato','อติวงศ์ ', NULL,'สุชาโต','atiwong@cp.eng.chula.ac.th','1111111111',21,10,'2013-05-01'),
       ...
       ('4567890123', 'Twittie', NULL,'Senivongse', 'ทวิตีย์',NULL,'เสนีวงศ์ ณ อยุธยา,','twittie.s@chula.ac.th','4444444444',21,10,'2010-05-01'),
       ('5678901234', 'Natawut', NULL, 'Nupairoj', 'ณัฐวุฒิ', NULL, 'หนูไพโรจน์', 'natawut.n@chula.ac.th', '5555555555', 21, 10, '2000-05-01'), 
       ('6789012345', 'Nattee', NULL, 'Niparnan', 'นัทที', NULL, 'นิภานันท์', 'nattee.n@chula.ac.th', '6666666666', 21, 10, '2004-05-01'),
